...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    @Bean
    @Qualifier("idp-pingfederate")
    public ExtendedMetadataDelegate pingFederateExtendedMetadataProvider()
            throws MetadataProviderException {
        ExtendedMetadataDelegate extendedMetadataDelegate = null;
        try {
            ClasspathResource resource = new ClasspathResource("/saml/pf/metadata.xml");
            ResourceBackedMetadataProvider resourceBackedMetadataProvider = new ResourceBackedMetadataProvider(backgroundTaskTimer, resource);
    ...
    public ExtendedMetadataDelegate oktaExtendedMetadataProvider()
            throws MetadataProviderException {
        String oktaMetadataURL = "https://dev-4420530.okta.com/app/exk8zkoaIJOUkYcjK5d5/sso/saml/metadata";
        HTTPMetadataProvider httpMetadataProvider = new HTTPMetadataProvider(
                this.backgroundTaskTimer, httpClient(), oktaMetadataURL);
    ...
    public CachingMetadataManager metadata() throws MetadataProviderException {
        ...
        providers.add(pingFederateExtendedMetadataProvider());
